...
sea.Seabattle.keyPress = function(event) {
	...
	if(sea.Seabattle.selectedShip >= 0 && sea.Seabattle.selectedShip < sea.Seabattle.ships.length) {
		...
		var dir = -2;
		console.log(HxOverrides.cca("a",0));
		switch(key) {
		...
		case HxOverrides.cca("r",0):
			...
			sea.Seabattle.selectedShip = (sea.Seabattle.selectedShip + 1) % sea.Seabattle.ships.length;
			return;
		}
		if(dir != -2) ship.pushOrder({ type : sea.OrderType.Move, dir : dir});
